...
class enemyClass:
    ...
    def createEnemyEntity(id, level, enemyGlobalData_IN) -> object:
        ...
        # for component in enemyGlobalData_COPY:
        #     if component == id:
        #         enemyData = enemy
        enemyData = enemyClass.levelSet(enemyData, level)
        return enemyData
        # else:
        #     debug.log('e', f'enemy (id: {id})does not exist ')
...
if __name__ == '__main__':
    ...
    inventory.addToInventory(itemDataList['weapons'][7], 1)
    inventory.addToInventory(itemDataList['weapons'][8], 1)
