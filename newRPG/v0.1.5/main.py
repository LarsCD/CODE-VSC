...
class system:
    ...
    def startUp():
        ...
        os.system('color 1') # sets the background to blue
...
playerClass.action.loadout.setWeapon(4)
playerClass.action.loadout.setArmor(4)
playerClass.action.loadout.setShield(4)
